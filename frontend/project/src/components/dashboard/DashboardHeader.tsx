...
import { Bell, Menu, User, LogOut, Settings, Anchor } from 'lucide-react';
...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({ sailorData, onMenuClick }) => {
  const [showProfileDropdown, setShowProfileDropdown] = useState(false);
  const [notifications] = useState([
    { id: 1, message: 'New shipment available from Port of Miami', time: '5 min ago', unread: true },
    { id: 2, message: 'Contract payment received', time: '1 hour ago', unread: true },
    { id: 3, message: 'Weather alert for your route', time: '2 hours ago', unread: false }
  ]);
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:block text-left">
                <div className="text-sm font-medium text-slate-800">{sailorData.name}</div>
                <div className="text-xs text-slate-500">Rating: {sailorData.rating}/5.0</div>
              </div>
            </button>
